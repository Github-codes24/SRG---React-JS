    ...
    <div>
      <div className="flex items-center justify-end mb-1">
        ...
        <span className="text-base md:text-xl">
          Home / Account Report / Bank Book
        </span>
      </div>

      <div className="bg-white rounded-md shadow-md my-2 ">
        <p className="p-3 text-xl text-[#878484]">Bank Book</p>
        <hr />
        <div className="p-3 text-[#595995] font-medium flex items-center gap-x-3">
          <label htmlFor="" className="mx-2">
            General Head <span className="text-red-500 font-semibold">*</span>
          </label>
          <select className="w-[20%] px-1 border py-1 rounded-md outline-none border-[#D3D1D1]">
        ...
        <div className="p-3 text-[#595995] font-medium flex items-center gap-x-3">
          <label htmlFor="" className="mx-2">
            Account Head <span className="text-red-500 font-semibold">*</span>
          </label>
          <input
            type="text"
            className="w-[20%] px-1 border py-1 rounded-md outline-none border-[#D3D1D1]"
          />
        </div>
        <div className="p-3 text-[#595995] font-medium flex items-center gap-x-10">
          <label htmlFor="" className="mx-2">
            From Date <span className="text-red-500 font-semibold">*</span>
          </label>
          <input
            type="date"
            className="border border-[#D3D1D1] outline-none w-[20%] py-1 rounded-md"
          />
        </div>
        <div className="p-3 text-[#595995] font-medium flex items-center gap-x-14">
          <label htmlFor="" className="mx-2">
          ...
          <input
            ...
            className="border border-[#D3D1D1] outline-none w-[20%] py-1 rounded-md"
          />
          <button className="bg-[#3A6D8C] text-white px-4 py-1 rounded-md">Find</button>
        </div>
      </div>

      <div className="bg-white shadow-md">
        <p className="p-3 text-[#878484] text-xl">Bank Book</p>
        <hr />
        <div>
          <div
        ...
        <p className="text-center text-[#787878] font-medium my-2">
          Cash Book Report (To Report From)
        </p>
          ...
          <table className="min-w-full border border-gray-300">
            ...
            <tbody>
              <tr className="hover:bg-gray-50">
                <td className="border border-gray-300 px-4 py-2 text-[#595995] font-medium">
                  Sl .No
                </td>
                <td className="border border-gray-300 px-4 py-2 text-[#595995] font-medium">
                  Date
