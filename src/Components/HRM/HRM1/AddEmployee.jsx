    ...
    <div>
      <div>
        ...
        <div className="   rounded-lg pt-[1px] pb-[1px] bg-white ">
          ...
          <div className="w-full flex px-2 font-bodyPop xl:text-[19px] sm:text-[16px]  flex-wrap ">
            <div className="w-1/2   p-1   min-w-[382px]">
              ...
              <div className="flex  mb-2 w-full   items-center justify-between pr-[45px] p-[12px]">
                <p className="flex text-[#595995] font-semibold">Designation </p>
                <select
                  id="countries"
              ...
              <div className="flex  mb-2 w-full   items-center justify-between pr-[45px] p-[12px]">
                <p className="flex text-[#595995] font-semibold">Rate Type </p>
                <select
                  id="countries"
                  className="border-gray-400 border-[1px] rounded-[5px] w-[59%]  dark:placeholder-gray-400 bg-white  px-[12px] p-[5px] text-gray-400" 
                >
              ...
              <div className="flex  mb-2 w-full   items-center justify-between pr-[45px] p-[12px]">
                <p className="flex text-[#595995] font-semibold">Address Line 1 </p>
                <textarea className="border-[1px] border-gray-300 w-[59%] rounded-[5px] px-[12px] h-[75px] p-[5px] text-gray-400"  name="comment" form="usrform" placeholder="Address Line 2"></textarea>
              </div>
              <div className="flex  mb-2 w-full   items-center justify-between pr-[45px] p-[12px]">
                <p className="flex text-[#595995] font-semibold">Picture </p>
                <input className="w-[59%] border-gray-400 border-[1px] rounded-[5px] px-[12px] p-[5px] text-gray-400" type="file" id="avatar" name="avatar" accept="image/png, image/jpeg" placeholder="browse"/>
              </div>
              <div className="flex  mb-2 w-full   items-center justify-between pr-[45px] p-[12px]">
              ...
              <div className="flex  mb-2 w-full   items-center justify-between pr-[45px] p-[12px]">
                <p className="flex text-[#595995] font-semibold">Residence Number </p>
                <input
                  className="w-[59%] border-gray-400 border-[1px] rounded-[5px] px-[12px] p-[5px]"
                  type="text"
            ...
            <div className="flex  mb-2 w-full   items-center justify-between pr-[45px] p-[12px]">
              ...
              <div className="flex  mb-2 w-full   items-center justify-between pr-[45px] p-[12px]">
                <p className="flex text-[#595995] font-semibold">Address Line 2 </p>
                <textarea className="border-[1px] border-gray-300 w-[59%] rounded-[5px] px-[12px] h-[75px] p-[5px]"  name="comment" form="usrform" placeholder="Address Line 2"></textarea>
              </div>
              <div className="flex  mb-2 w-full   items-center justify-between pr-[45px] p-[12px]">
        ...
        <div className="w-full p-[10px] flex justify-center">
            <button type="submit" form="form1" className="bg-[#3A6D8C] text-white w-[106px] h-[46px] rounded-[11px]">Submit</button>
        </div>
        </div>
      </div>
    </div>
