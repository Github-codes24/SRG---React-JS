      ...
      <>
        <div className="flex items-center justify-end">
          ...
          <span className="text-base md:text-xl">
            Home / HRM / Office Loan / Add Payment
          </span>
        </div>
        <br />
        ...
        <div className="bg-white p-4">
          <div className="flex justify-between items-center space-x-4">
            <h3 className="text-xl font-extralight">Add Payment</h3>
            <div className="flex space-x-4">
              ...
              <button
                ...
                className="flex items-center px-4 py-2 bg-[#746BD9] text-white rounded-lg"
              >
                <IoMdAdd className="mr-2" /> Add Loan
              </button>
          ...
          <div className="flex items-center mb-4">
            ...
            >
              ...
              <option value="employee1" className="text-gray-400">
                Voucher 1
              </option>
              <option value="employee2" className="text-gray-400">
                Voucher 2
              </option>
              <option value="employee3" className="text-gray-400">
                Voucher 3
              </option>
            </select>
          </div>
          ...
          <div className="flex items-center mb-4">
            <label htmlFor="bank" className="text-gray-700 font-medium w-60">
          ...
          <div className="flex items-center mb-4">
            <label htmlFor="details" className="text-gray-700 font-medium w-60">
              Details
            </label>
            <textarea
              id="details"
