            ...
            <table className="border-collapse border-slate-400 border-2 w-full h-full font-bodyPop text-left">
              <thead>
                <tr className="  text-[#595995]  font-medium  h-[60px]">
                  <th className="border border-slate-300 pl-[8px]">
                  ...
                  <th className="border border-slate-300 pl-[8px]">Paid By</th>
              ...
              <tbody className="text-left text-[#636465BD]">
                <tr className="  h-[60px]">
                  ...
                  <td className="border border-slate-300 pl-[8px]">
                    IBRAHIM A SEAD
                  </td>
                  <td className="border border-slate-300 pl-[8px]">
                    January 2024
                  </td>
                  <td className="border border-slate-300 pl-[8px]">1000.00</td>
                  <td className="border border-slate-300 pl-[8px]">0</td>
                  <td className="border border-slate-300 pl-[8px]">0</td>
                  <td className="border border-slate-300 pl-[8px]">Paid</td>
                  <td className="border border-slate-300 pl-[8px]">
                    2024-July-10
                  </td>
                  <td className="border border-slate-300 pl-[8px]">
                  ...
                  <td className="border border-slate-300 pl-[8px]">
                    <div className="flex gap-[4px] w-full justify-center pl-[5px]">
                      <button
                        type="submit"
                        form="form2"
                        className="bg-[#62A4B8] text-white w-[80px] h-[36px] rounded-[11px]"
                        onClick={()=>{
                          navigate('/PaySlip')
                        }}
                      >
                ...
                <tr className=" h-[60px]">
                  ...
                  <td className="border border-slate-300 pl-[8px]">0</td>
                  <td className="border border-slate-300 pl-[8px]">0</td>
                  <td className="border border-slate-300 pl-[8px]"></td>
                  <td className="border border-slate-300 pl-[8px]"></td>
                  <td className="border border-slate-300 pl-[8px]"></td>
                  <td className="border border-slate-300 pl-[8px]">
                    <div className="flex gap-[4px] w-full justify-center pl-[5px]">
                      <button
                        type="submit"
                        form="form2"
                        className="bg-[#40A483] text-white w-[80px] h-[36px] rounded-[11px]"
                      >
                        Pay Now
                      </button>
                    </div>
