...
export default function ManageSalaryGenerate() {
  return (
    <div>
      <div className='mb-[11%]'>
          ...
          <table className="border-collapse border-slate-400 border-2 w-full h-full font-bodyPop text-left">
              <thead>
                <tr className="  text-[#595995]  font-medium  h-[60px]">
                  ...
                  <th className="border border-slate-300 pl-[8px]"><div className="flex justify-between">Salary Month<LuArrowUpDown className="w-auto h-[18px]" /></div></th>
                  <th className="border border-slate-300 pl-[8px]"><div className="flex justify-between">Generated By<LuArrowUpDown className="w-auto h-[18px]" /></div></th>
              ...
              <tbody className="text-left text-[#636465BD]">
                <tr className="  h-[60px]">
                  ...
                  <td className="border border-slate-300 pl-[8px]">January 2024</td>
                  <td className="border border-slate-300 pl-[8px]">Admin User</td>
                ...
                <tr className="  h-[60px]">
                  ...
                  <td className="border border-slate-300 pl-[8px]">February 204</td>
                  <td className="border border-slate-300 pl-[8px]">Admin User</td>
                  <td className="border border-slate-300 pl-[8px]"><div className="flex gap-[4px] w-full justify-left pl-[5px]">
                    <BsPencil className="bg-[#96CEB4] p-[2px] h-[30px] w-[30px] rounded-[2px] border-[1px] border-[#75A68F]" color="white"/>
                    <FaRegTrashAlt className="bg-[#CB6040] p-[2px] h-[30px] w-[30px] rounded-[2px] border-[#BF2D35] border-[1px]" color="white"/>
                ...
                <tr className="  h-[60px]">
                  ...
                  <td className="border border-slate-300 pl-[8px]">March 204</td>
                  <td className="border border-slate-300 pl-[8px]">Admin User</td>
                  <td className="border border-slate-300 pl-[8px]"><div className="flex gap-[4px] w-full justify-left pl-[5px]">
                    <BsPencil className="bg-[#96CEB4] p-[2px] h-[30px] w-[30px] rounded-[2px] border-[1px] border-[#75A68F]" color="white"/>
                    <FaRegTrashAlt className="bg-[#CB6040] p-[2px] h-[30px] w-[30px] rounded-[2px] border-[#BF2D35] border-[1px]" color="white"/>
                ...
                <tr className="  h-[60px]">
                  ...
                  <td className="border border-slate-300 pl-[8px]">April 2024</td>
                  <td className="border border-slate-300 pl-[8px]">Admin User</td>
                  <td className="border border-slate-300 pl-[8px]"><div className="flex gap-[4px] w-full justify-left pl-[5px]">
                    <BsPencil className="bg-[#96CEB4] p-[2px] h-[30px] w-[30px] rounded-[2px] border-[1px] border-[#75A68F]" color="white"/>
                    <FaRegTrashAlt className="bg-[#CB6040] p-[2px] h-[30px] w-[30px] rounded-[2px] border-[#BF2D35] border-[1px]" color="white"/>
                ...
                <tr className="  h-[60px]">
                  <td className="border border-slate-300 pl-[8px]">5</td>
                  <td className="border border-slate-300 pl-[8px]">May 2024</td>
                  <td className="border border-slate-300 pl-[8px]">Admin User</td>
                  <td className="border border-slate-300 pl-[8px]"><div className="flex gap-[4px] w-full justify-left pl-[5px]">
                    <BsPencil className="bg-[#96CEB4] p-[2px] h-[30px] w-[30px] rounded-[2px] border-[1px] border-[#75A68F]" color="white"/>
                    <FaRegTrashAlt className="bg-[#CB6040] p-[2px] h-[30px] w-[30px] rounded-[2px] border-[#BF2D35] border-[1px]" color="white"/>
                ...
                <tr className="  h-[60px]">
                  <td className="border border-slate-300 pl-[8px]">6</td>
                  <td className="border border-slate-300 pl-[8px]">June 2024</td>
                  <td className="border border-slate-300 pl-[8px]">Admin User</td>
                  <td className="border border-slate-300 pl-[8px]"><div className="flex gap-[4px] w-full justify-left pl-[5px]">
                    <BsPencil className="bg-[#96CEB4] p-[2px] h-[30px] w-[30px] rounded-[2px] border-[1px] border-[#75A68F]" color="white"/>
                    <FaRegTrashAlt className="bg-[#CB6040] p-[2px] h-[30px] w-[30px] rounded-[2px] border-[#BF2D35] border-[1px]" color="white"/>
                ...
                <tr className="  h-[60px]">
                  <td className="border border-slate-300 pl-[8px]">7</td>
                  <td className="border border-slate-300 pl-[8px]">July 2024</td>
                  <td className="border border-slate-300 pl-[8px]">Admin </td>
                  <td className="border border-slate-300 pl-[8px]"><div className="flex gap-[4px] w-full justify-left pl-[5px]">
                    <BsPencil className="bg-[#96CEB4] p-[2px] h-[30px] w-[30px] rounded-[2px] border-[1px] border-[#75A68F]" color="white"/>
                    <FaRegTrashAlt className="bg-[#CB6040] p-[2px] h-[30px] w-[30px] rounded-[2px] border-[#BF2D35] border-[1px]" color="white"/>
                ...
                <tr className="  h-[60px]">
                  <td className="border border-slate-300 pl-[8px]">8</td>
                  <td className="border border-slate-300 pl-[8px]">August 2024</td>
                  <td className="border border-slate-300 pl-[8px]">Admin User</td>
                  <td className="border border-slate-300 pl-[8px]"><div className="flex gap-[4px] w-full justify-left pl-[5px]">
                    <BsPencil className="bg-[#96CEB4] p-[2px] h-[30px] w-[30px] rounded-[2px] border-[1px] border-[#75A68F]" color="white"/>
                    <FaRegTrashAlt className="bg-[#CB6040] p-[2px] h-[30px] w-[30px] rounded-[2px] border-[#BF2D35] border-[1px]" color="white"/>
                ...
                <tr className="  h-[60px]">
                  <td className="border border-slate-300 pl-[8px]">9</td>
                  <td className="border border-slate-300 pl-[8px]">September 2024</td>
                  <td className="border border-slate-300 pl-[8px]">Admin User</td>
                  <td className="border border-slate-300 pl-[8px]"><div className="flex gap-[4px] w-full justify-left pl-[5px]">
                    <BsPencil className="bg-[#96CEB4] p-[2px] h-[30px] w-[30px] rounded-[2px] border-[1px] border-[#75A68F]" color="white"/>
                    <FaRegTrashAlt className="bg-[#CB6040] p-[2px] h-[30px] w-[30px] rounded-[2px] border-[#BF2D35] border-[1px]" color="white"/>
                ...
                <tr className="  h-[60px]">
                  <td className="border border-slate-300 pl-[8px]">10</td>
                  <td className="border border-slate-300 pl-[8px]">October 2024</td>
                  <td className="border border-slate-300 pl-[8px]">Admin User</td>
                  <td className="border border-slate-300 pl-[8px]"><div className="flex gap-[4px] w-full justify-left pl-[5px]">
                    <BsPencil className="bg-[#96CEB4] p-[2px] h-[30px] w-[30px] rounded-[2px] border-[1px] border-[#75A68F]" color="white"/>
                    <FaRegTrashAlt className="bg-[#CB6040] p-[2px] h-[30px] w-[30px] rounded-[2px] border-[#BF2D35] border-[1px]" color="white"/>
                ...
                <tr className="  h-[60px]">
                  <td className="border border-slate-300 pl-[8px]">11</td>
                  <td className="border border-slate-300 pl-[8px]">November 2024</td>
                  <td className="border border-slate-300 pl-[8px]">Admin User</td>
                  <td className="border border-slate-300 pl-[8px]"><div className="flex gap-[4px] w-full justify-left pl-[5px]">
                    <BsPencil className="bg-[#96CEB4] p-[2px] h-[30px] w-[30px] rounded-[2px] border-[1px] border-[#75A68F]" color="white"/>
                    <FaRegTrashAlt className="bg-[#CB6040] p-[2px] h-[30px] w-[30px] rounded-[2px] border-[#BF2D35] border-[1px]" color="white"/>
