...
export default function BusinessLiquidityReport() {
  return (
    <div>
        <div>
      ...
      <IoHomeOutline className="xl:w-[30px] xl:h-[34px] lg:w-[21px] lg:h-[21px] text-[#3A6D8C]" />
        ...
        <a href="">Business Liquidity Report</a>
      </div>
      <div
      ...
      >
        ...
        <div>
          ...
          <div className=" flex flex-col font-medium   text-[#355B8B] gap-y-1  pt-[20px]">
                <div className="flex gap-5 mb-[9px]">
                  {" "}
        ...
        <div className="flex items-center p-[13px]">
          <button className=" p-[7px] w-[89px] text-[17px] flex rounded-xl h-[45px] mr-[9px] bg-[#024CAA]">
            <BsSearch color="white" className=" h-full mr-[5px]" />
            <p className=" text-white">Search</p>
          </button>
          <button className=" p-[7px] w-[89px] text-[17px] flex rounded-xl h-[45px] mr-[9px] bg-[#FF6500]">
      ...
      <div className="   rounded-lg pt-[1px] pb-[1px] bg-white mb-[34px]">
        ...
        <div className="w-full p-[20px] ">
            <div className='  mx-auto w-[88%] flex justify-between '>
            <div className=" h-[600px]  w-[44%]">
            <table className="border-collapse border-slate-400 border-2 w-full h-full">
                <thead>
                <tr className="  text-[#595995]  font-medium">
                        <th colSpan={3} className="border border-slate-300 text-[18px] ...">Current Assets</th>
                    </tr>
                </thead>
              <thead>
                <tr className="  text-[#595995]  font-medium">
                  <th className="border border-slate-300 ...">SL.</th>
                  <th className="border border-slate-300 ...">Ledger Name</th>
              ...
              <tbody className="text-center text-[#636465BD]">
                ...
                <tr className=" ">
                  <td className="border text-[#595995] font-semibold border-slate-300 ..." colSpan={2}>Total Amount</td>
                  <td className="border border-slate-300 ..."></td>
                </tr>
              </tbody>
            </table>
            ...
            <table className="border-collapse border-slate-400 border-2 w-full h-full">
                <thead>
                <tr className="  text-[#595995]  font-medium">
                        <th colSpan={3} className="border border-slate-300 text-[18px] ...">Current Liabilities</th>
                    </tr>
                </thead>
              <thead>
                <tr className="  text-[#595995]  font-medium">
