...
export default function SalesReturn() {
  return (
    <div>
      ...
      <a href="">Home</a>/ <a href="">Reports</a> / <a href="">Sales Return</a>
    </div>
    ...
    <div className="   rounded-lg pt-[1px] pb-[70px] bg-white mb-[34px]">
        <div className=" border-b-2 border-gray-400 mb-[4px] p-[6px] flex justify-between">
          <h3 className=" flex items-center text-[25px] text-[#878484]">Sales Return</h3>
          ...
          <table className="border-collapse border-slate-400 border-2 w-full h-full">
            <thead>
              <tr className=" text-[#595995] font-normal">
                ...
                <th className="border border-slate-300 ...">Invoice ID</th>
            ...
            <tbody className="text-center text-[#636465BD]">
              <tr className=" bg-slate-100">
                ...
                <td className="border border-slate-300 ...">28374746484</td>
              ...
              <tr>
                ...
                <td className="border border-slate-300 ...">30484552829</td>
                <td className="border border-slate-300 ...">Shrutika Savarkar</td>
                <td className="border border-slate-300 ...">08-Aug-2024</td>
