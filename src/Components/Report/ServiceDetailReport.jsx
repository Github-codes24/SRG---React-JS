...
export default function ServiceDetailReport() {
  return (
    <div>
        ...
        <a href="">Service Detailed Report</a>
      </div>
      <div
      ...
      >
        ...
        <div className="flex items-center p-[13px]">
          <button className=" p-[7px] w-[89px] flex rounded-xl text-[17px] h-[45px] mr-[9px] bg-[#024CAA]">
            <BsSearch color="white" className=" h-full mr-[5px]" />
            <p className=" text-white">Search</p>
          </button>
          <button className=" p-[7px] w-[89px] flex rounded-xl text-[17px] h-[45px] mr-[9px] bg-[#FF6500]">
        ...
        <div className="  w-full p-[20px] ">
          <table className="border-collapse border-slate-400 border-2 w-full h-full">
            <thead>
              ...
              <th className="border border-slate-300 h-[50px]   ..."><div className=' flex justify-between item-center '>Sl. <IoIosArrowDown className='mt-[5px]'/></div></th>
                <th className="border border-slate-300 h-[50px]   ...">
                    <div className=' flex justify-between item-center '>
                  Voucher No<IoIosArrowDown className='mt-[5px]'/>
                  </div>
                </th>
                <th className="border border-slate-300 h-[50px]   ...">
                    <div className=' flex justify-between item-center '>
                  Voucher Date<IoIosArrowDown className='mt-[5px]'/>
                  </div>
                </th>
                <th className="border border-slate-300 h-[50px]   ...">
                    <div className=' flex justify-between item-center '>
                  Voucher Type<IoIosArrowDown className='mt-[5px]'/>
                  </div>
                </th>
                <th className="border border-slate-300 h-[50px]   ...">
                    <div className=' flex justify-between item-center '>
                  Customer Name<IoIosArrowDown/>
                  </div>
                </th>
                
                <th className="border border-slate-300 h-[50px]   ..."><div className=' flex justify-between item-center '>Mobile No <IoIosArrowDown className='mt-[5px]'/></div></th>
                <th className="border border-slate-300 h-[50px]   ..."><div className=' flex justify-between item-center '>Service Name <IoIosArrowDown className='mt-[5px]'/></div></th>
                <th className="border border-slate-300 h-[50px]   ..."><div className=' flex justify-between item-center '>Invoice Amount <IoIosArrowDown className='mt-[5px]'/></div></th>
                <th className="border border-slate-300 h-[50px]   ..."><div className=' flex justify-between item-center '>Cash Receipt <IoIosArrowDown className='mt-[5px]'/></div></th>
                <th className="border border-slate-300 h-[50px]   ..."><div className=' flex justify-between item-center '>Cash Payment <IoIosArrowDown className='mt-[5px]'/></div></th>
              </tr>
            </thead>
