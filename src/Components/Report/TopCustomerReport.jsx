          ...
          <table className="border-collapse border-slate-400 border-2 w-full h-full">
            <thead>
              ...
              <th className="border border-slate-300 h-[50px]   ..."><div className=' flex justify-between item-center '>Sl. <IoIosArrowDown className='mt-[5px]'/></div></th>
                <th className="border border-slate-300 h-[50px]   ..."><div className=' flex justify-between item-center '>Customer Name <IoIosArrowDown className='mt-[5px]'/></div></th>
                ...
                <th className="border border-slate-300 h-[50px]   ..."><div className=' flex justify-between item-center '>Service Category <IoIosArrowDown className='mt-[5px]'/></div></th>
                <th className="border border-slate-300 h-[50px]   ..."><div className=' flex justify-between item-center '>Sell Amount <IoIosArrowDown className='mt-[5px]'/></div></th>
                <th className="border border-slate-300 h-[50px]   ..."><div className=' flex justify-between item-center '>Service Charge Receipts <IoIosArrowDown className='mt-[5px]'/></div></th>
              </tr>
            </thead>
