                ...
                <table className="min-w-full bg-white border border-gray-300">
                  <thead>
                    <tr className="text-[#595995] ">
                      <th className="border px-4 py-2">Payment Ledger Name</th>

                      <th className="border px-4 py-2">
                        On Hand Balance [Credit A/C]
                      </th>
                  ...
                  <tbody className="text-[#355B8B99]">
                    ...
                    <tr className="hover:bg-gray-100 text-[#595995] font-medium">
                      ...
                      <td className="border px-4 py-2 text-center"><input type="text" className="w-full bg-gray-200" /></td>
