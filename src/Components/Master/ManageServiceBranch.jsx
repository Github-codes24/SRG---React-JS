...
const ManageServiceBranch = () => {
  const data = [
    { id: 1, name: 'Online Service' },
    { id: 2, name: 'Online Service' },
    { id: 3, name: 'Online Service' },
    { id: 4, name: 'Online Service' },
    { id: 5, name: 'Online Service' },
...
<div className="flex justify-between items-center mb-6">
        <h2 className="text-[#878484] text-xl md:text-2xl font-normal mb-2">Manage Service Branch</h2>
        <button
      ...
      <table className="w-full border-collapse border border-gray-300">
        <thead>
          <tr className="bg-gray-100">
            ...
            <th className="border text-[#746BD9] p-2 text-left">Account Head</th>
...
export default ManageServiceBranch;
