...
const LedgerList = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const dataToSend = {
      ...formData,
      amount: parseFloat(formData.amount) || 0, // Convert amount to number, default to 0 if invalid
    };
        ...
        <div className="grid grid-cols-1 gap-6">
          ...
          <div className="flex items-center space-x-4 sm:col-span-2 mt-4">
            ...
            >
              ...
              <option value="Receipts">Receipt Payment</option>
              <option value="Payments">Cash Payment</option>
            </select>
          </div>
