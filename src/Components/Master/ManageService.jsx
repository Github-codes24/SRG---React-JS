...
const ManageService = () => {
  const data = [
    { id: 1, branch: 'Online Service ',name: '' , category:'',buyAmount:'200',selfAmount:'300',profit:'100.00',},
    { id: 2,  branch: 'Online Service ',name: '',category:'' ,buyAmount:'0.00',selfAmount:'5.00',profit:'5.00',},
    { id: 3,  branch: 'Online Service ',name: '', category:'',buyAmount:'0.00', selfAmount:'150',profit:'150.00',},
    { id: 4,  branch: 'Online Service ',name: '',category:'' ,buyAmount:'',selfAmount:'',profit:'100.00',},
    { id: 5, name: '',profit:'12.00' },
...
<div className="flex justify-between items-center mb-6">
        <h2 className="text-[#878484] text-xl md:text-2xl font-normal mb-2">Manage Service</h2>
        <button
      ...
      <table className="w-full border-collapse border border-gray-300">
        <thead>
          <tr className="bg-gray-100">
            <th className="border text-[#595995] p-2 text-left">Service No.</th>
            <th className="border text-[#595995] p-2 text-left">Service Branch</th>
            <th className="border text-[#595995] p-2 text-left">Service Name</th>
            <th className="border text-[#595995] p-2 text-left">Service Category</th>
            <th className="border text-[#595995] p-2 text-left">Buy Amount</th>
            <th className="border text-[#595995] p-2 text-left">Self Amount</th>
            <th className="border text-[#595995] p-2 text-left">Profit</th>
        ...
        <tbody>
          {data.map((item) => (
            <tr key={item.id} className="odd:bg-white even:bg-gray-50">
              ...
              <td className="border border-gray-300 p-2">{item.branch}</td>
              <td className="border border-gray-300 p-2">{item.name}</td>
              <td className="border border-gray-300 p-2">{item.category}</td>
              <td className="border border-gray-300 p-2">{item.buyAmount}</td>
              <td className="border border-gray-300 p-2">{item.selfAmount}</td>
