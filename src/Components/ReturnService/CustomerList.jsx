        ...
        <div className="flex justify-between">
          ...
          <div className="flex flex-col space-y-4">
            <div className="flex items-center ">
              <label
                htmlFor="invoiceNo"
                className="text-gray-700 font-medium w-40"
              >
                Return Invoice No
              </label>
              <input
            ...
            <div className="flex items-center">
              <label htmlFor="date" className="text-gray-700 font-medium w-40">
                Date
              </label>
              <input
                type="date"
          ...
          <table className="min-w-full bg-white border border-gray-300">
            <thead>
              <tr className="bg-gray-100">
                <th className="py-2 px-4 border border-gray-300 text-left text-gray-700 font-medium">
                  Service Name
                </th>
                <th className="py-2 px-4 border border-gray-300 text-left text-gray-700 font-medium">
                  Service Category
